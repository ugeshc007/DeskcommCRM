...
const DICIONARIO_BASE: Traducoes = {
  ...
  // Rótulos de apresentação do vocabulário canônico; o valor salvo segue em português.
  "dúvida": { es: "duda" },
  "reclamação": { es: "queja" },
  "troca": { es: "cambio" },
  "devolução": { es: "devolución" },
  "elogio": { es: "elogio" },
  ...
  "Exemplos para começar": { es: "Ejemplos para empezar" },
  "Cada exemplo cria um rascunho editável. Revise o gatilho, os tempos e as mensagens antes de publicar.": {
    es: "Cada ejemplo crea un borrador editable. Revisa el disparador, los tiempos y los mensajes antes de publicar.",
  },
  "Etapas incluídas": { es: "Etapas incluidas" },
  "Usar este exemplo": { es: "Usar este ejemplo" },
  "Criando rascunho…": { es: "Creando borrador…" },
  "Não consegui criar o exemplo. Tente de novo.": { es: "No pude crear el ejemplo. Intenta de nuevo." },
  "Acompanhamento de proposta comercial": { es: "Seguimiento de propuesta comercial" },
  "Para vendas consultivas ou serviços depois que uma proposta foi enviada.": { es: "Para ventas consultivas o servicios después de enviar una propuesta." },
  "Início manual": { es: "Inicio manual" },
  "Aguardar 3 dias": { es: "Esperar 3 días" },
  "Tirar dúvidas": { es: "Resolver dudas" },
  "Aguardar mais 4 dias": { es: "Esperar 4 días más" },
  "Encerrar com clareza": { es: "Cerrar con claridad" },
  "Reengajar lead em silêncio": { es: "Reactivar lead en silencio" },
  "Para retomar uma conversa quando o contato não responde por 24 horas.": { es: "Para retomar una conversación cuando el contacto no responde durante 24 horas." },
  "24 horas de silêncio": { es: "24 horas de silencio" },
  "Retomada educada": { es: "Retoma cordial" },
  "Encerrar esta tentativa": { es: "Finalizar este intento" },
  "Recuperação de carrinho abandonado": { es: "Recuperación de carrito abandonado" },
  "Para lojas que recebem um evento de checkout ou pagamento pendente por webhook.": { es: "Para tiendas que reciben por webhook un evento de checkout o pago pendiente." },
  "Evento por webhook": { es: "Evento por webhook" },
  "Aguardar 2 horas": { es: "Esperar 2 horas" },
  "Lembrar do pagamento": { es: "Recordar el pago" },
  "Aguardar 22 horas": { es: "Esperar 22 horas" },
  "Última ajuda": { es: "Última ayuda" },
  "Remarcar atendimento não realizado": { es: "Reprogramar atención no realizada" },
  "Para clínicas e serviços com agenda quando a pessoa não comparece.": { es: "Para clínicas y servicios con agenda cuando la persona no se presenta." },
  "Não comparecimento": { es: "Inasistencia" },
  "Aguardar 1 hora": { es: "Esperar 1 hora" },
  "Oferecer remarcação": { es: "Ofrecer reprogramación" },
  "Perguntar se há dúvidas": { es: "Preguntar si hay dudas" },
  "Última tentativa educada": { es: "Último intento cordial" },
  "Tentativas concluídas": { es: "Intentos finalizados" },
  "Modelo de exemplo: revise antes de publicar.": { es: "Modelo de ejemplo: revísalo antes de publicar." },
  "Contato em silêncio por 24 horas": { es: "Contacto en silencio durante 24 horas" },
  "Retomar a conversa": { es: "Retomar la conversación" },
  "Tentativa concluída": { es: "Intento finalizado" },
  "Aguardando uma nova resposta do contato.": { es: "Esperando una nueva respuesta del contacto." },
  "Checkout pendente recebido": { es: "Checkout pendiente recibido" },
  "Aguardar mais 22 horas": { es: "Esperar 22 horas más" },
  "Oferecer ajuda uma última vez": { es: "Ofrecer ayuda una última vez" },
  "Atendimento não realizado": { es: "Atención no realizada" },
  "Aguardando solicitação de remarcação.": { es: "Esperando una solicitud de reprogramación." },
  "Retome a proposta com educação, ofereça ajuda e pergunte se existe alguma dúvida. Não invente preço, prazo ou condição.": { es: "Retoma la propuesta con cordialidad, ofrece ayuda y pregunta si hay alguna duda. No inventes precios, plazos ni condiciones." },
  "Faça uma última tentativa breve e respeitosa. Deixe claro que a pessoa pode retomar a conversa quando quiser. Não pressione.": { es: "Haz un último intento breve y respetuoso. Deja claro que la persona puede retomar la conversación cuando quiera. No presiones." },
  "Retome a conversa de forma breve e útil, usando apenas o contexto já confirmado. Faça uma pergunta simples e não pressione.": { es: "Retoma la conversación de forma breve y útil, usando solo el contexto confirmado. Haz una pregunta sencilla y no presiones." },
  "Lembre o contato de forma prestativa que o checkout ficou pendente e ofereça ajuda. Não invente disponibilidade, desconto ou link.": { es: "Recuerda de forma servicial que el checkout quedó pendiente y ofrece ayuda. No inventes disponibilidad, descuentos ni enlaces." },
  "Ofereça ajuda uma última vez, de forma curta e sem pressão. Use somente dados confirmados da conversa.": { es: "Ofrece ayuda una última vez, de forma breve y sin presión. Usa solo datos confirmados de la conversación." },
  "Pergunte com empatia se a pessoa deseja remarcar. Não confirme horário sem consultar a agenda e não atribua culpa.": { es: "Pregunta con empatía si la persona desea reprogramar. No confirmes horarios sin consultar la agenda ni atribuyas culpa." },
  ...
  "Credencial do canal oficial validada": { es: "Credencial del canal oficial validada" },
  "Proteção de envio": { es: "Protección de envío" },
  ...
  "Quem esfriou e ainda está aberto — o que corre risco de morrer sem resposta.": { es: "Quienes se enfriaron y siguen abiertos: lo que corre riesgo de quedar sin respuesta." },
  "Scripts salvos para responder mais rápido, seus ou da equipe.": { es: "Respuestas guardadas para contestar más rápido, tuyas o del equipo." },
  "Seus funis de venda — clique em um para abrir o quadro de clientes.": { es: "Tus embudos de ventas: selecciona uno para abrir el tablero de clientes." },
  "As pessoas do outro lado da conversa e seu histórico.": { es: "Las personas al otro lado de la conversación y su historial." },
  ...
  "Qual agente pega qual conversa, e quando o humano assume.": { es: "Qué agente toma cada conversación y cuándo interviene una persona." },
  ...
  "Qual inteligência atende cada parte do sistema — e o que acontece se ela falhar.": { es: "Qué inteligencia atiende cada parte del sistema y qué ocurre si falla." },
  "Conhecimento": { es: "Conocimiento" },
  "Os materiais que o agente consulta antes de responder sobre o seu negócio.": { es: "Los materiales que consulta el agente antes de responder sobre tu negocio." },
  "Ensinar o agente": { es: "Enseñar al agente" },
  "Memória": { es: "Memoria" },
  "O que o agente já aprendeu sobre a sua operação e reaproveita.": { es: "Lo que el agente ya aprendió sobre tu operación y reutiliza." },
  "Skills": { es: "Habilidades" },
  "As ações que o agente pode executar sozinho durante o atendimento.": { es: "Las acciones que el agente puede ejecutar por sí solo durante la atención." },
  "Os atendimentos que o agente conduziu, do início ao desfecho.": { es: "Las atenciones que condujo el agente, desde el inicio hasta el resultado." },
  "Acompanhar o agente": { es: "Supervisar al agente" },
  "Alertas": { es: "Alertas" },
  "O que a IA encontrou e precisa de uma decisão sua.": { es: "Lo que encontró la IA y necesita una decisión tuya." },
  "Melhorias que a IA sugere para si mesma, esperando sua decisão.": { es: "Mejoras que la IA se propone a sí misma y esperan tu decisión." },
  "O que a IA fez — e, quando falhou, o que aconteceu e o que fazer.": { es: "Qué hizo la IA y, cuando falló, qué ocurrió y qué hacer." },
  "Uso e orçamento": { es: "Uso y presupuesto" },
  "Quanto a IA consumiu e qual é o teto de gasto do mês.": { es: "Cuánto consumió la IA y cuál es el límite de gasto mensual." },
  "Seus números de WhatsApp: por QR ou canal oficial da Meta, com saúde, reconexão e templates.": { es: "Tus números de WhatsApp: por QR o canal oficial de Meta, con estado, reconexión y plantillas." },
  ...
  "Avise outros sistemas quando algo acontecer aqui dentro.": { es: "Avisa a otros sistemas cuando ocurra algo aquí." },
  "Funil e performance por atendente nos últimos 30 dias.": { es: "Embudo y rendimiento por agente durante los últimos 30 días." },
  "Quanto custou cada resultado das campanhas que trazem gente para cá.": { es: "Cuánto costó cada resultado de las campañas que traen personas hasta aquí." },
  "Relatório do que a equipe e os agentes fizeram no período: quanto, quem e de que tipo.": { es: "Informe de lo que hicieron el equipo y los agentes en el período: cuánto, quién y de qué tipo." },
  "Se o agente está melhorando, onde ele erra e o que falta ensinar.": { es: "Si el agente está mejorando, dónde se equivoca y qué falta enseñarle." },
  "Quem fez o quê, quando — o histórico que não se apaga.": { es: "Quién hizo qué y cuándo: el historial que no se borra." },
  "Devolver ao anúncio as vendas que ele trouxe, para ele aprender a procurar mais clientes parecidos.": { es: "Devolver al anuncio las ventas que generó para que aprenda a buscar más clientes parecidos." },
  "Conectar a conta de anúncios para ler o desempenho das campanhas.": { es: "Conectar la cuenta de anuncios para consultar el rendimiento de las campañas." },
  ...
  "Rótulo da regra": { es: "Etiqueta de la regla" },
  "Comparação da regra": { es: "Comparación de la regla" },
  "Texto da regra": { es: "Texto de la regla" },
  "texto a casar": { es: "texto que debe coincidir" },
  "Remover regra": { es: "Eliminar regla" },
  ...
  "boas-vindas, novo-lead": { es: "bienvenida, nuevo-lead" },
  "https://meusistema.com/webhook": { es: "https://misistema.com/webhook" },
  "https://tusitio.com/gracias": { es: "https://tusitio.com/gracias" },
  "Entendi": { es: "Entendido" },
  "vip, recompra": { es: "vip, recompra" },
  "minutos": { es: "minutos" },
  "Última alteração em": { es: "Último cambio el" },
  "Acompanhamento encerrado. Confirmando acesso…": {
    es: "Acompañamiento finalizado. Confirmando el acceso…",
  },
  "Encerrando acompanhamento…": { es: "Finalizando el acompañamiento…" },
  ...
  "Consulta marcada": { es: "Cita programada" },
  "Não vai marcar": { es: "No va a agendar" },
  "Interessados": { es: "Interesados" },
  "Novo interessado": { es: "Nuevo interesado" },
  "Entendendo o que procura": { es: "Entendiendo lo que busca" },
  ...
  "Nota recente": { es: "Nota reciente" },
  "Autor não identificado": { es: "Autor no identificado" },
  "Adicionar nota": { es: "Agregar nota" },
  "Registre a conversa ou o próximo passo": { es: "Registra la conversación o el próximo paso" },
  "Salvar nota": { es: "Guardar nota" },
  "Nota adicionada": { es: "Nota agregada" },
  "Não foi possível salvar a nota.": { es: "No se pudo guardar la nota." },
  "Envelhecimento de leads": { es: "Antigüedad de leads" },
  "Leads abertos que permanecem numa etapa além do prazo escolhido.": { es: "Leads abiertos que permanecen en una etapa más allá del plazo elegido." },
  "Leads abertos que permanecem na etapa atual além do prazo escolhido.": { es: "Leads abiertos que permanecen en su etapa actual más allá del plazo elegido." },
  "Dias na etapa": { es: "Días en la etapa" },
  "Mostrar leads": { es: "Mostrar leads" },
  "Não foi possível carregar o relatório de envelhecimento.": { es: "No se pudo cargar el informe de antigüedad." },
  "leads abertos acima de": { es: "leads abiertos superan" },
  "dias. Mostrando os 100 mais antigos.": { es: "días. Se muestran los 100 más antiguos." },
  "Na etapa desde": { es: "En la etapa desde" },
  "Nenhum lead ultrapassa este prazo.": { es: "Ningún lead supera este plazo." },
  ...
  "O servidor de o WhatsApp (WAHA) foi encontrado, mas recusou a conexão: nada está atendendo naquela porta. Confirme que o serviço está no ar e que a porta configurada é a dele.": { es: "Se encontró el servidor de WhatsApp (WAHA), pero rechazó la conexión: no hay nada escuchando en ese puerto. Confirma que el servicio esté activo y que el puerto configurado sea el correcto." },
