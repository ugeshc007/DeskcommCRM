...
export const TOOLS_COMERCIO = declararTools([
  { name: 'crm_quote_store_checkout', category: 'write', opt_in_only: true, rotulo: 'Prepare store quote',
  ...
  { name: 'crm_confirm_store_checkout', category: 'write', opt_in_only: true, rotulo: 'Confirm store checkout',
  ...
  { name: 'crm_store_order_status', category: 'read', opt_in_only: true, rotulo: 'Check store payment status',
  ...
  {
    name: 'crm_search_store_products', category: 'read', opt_in_only: true,
